                        ...
                        if($_SESSION['user__id'])
                        {
                            ...
                            echo '
                             <li class="nav-item ms-lg-auto dropdown">
                                <a class="nav-link dropdown-toggle" id="navbarLightDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false"><img style="height:50px;border-radius:50%;aspect-ratio: 1/1;object-fit: contain;border:1px solid lightgray;"  src="'.$img.'" alt="Image" href="profile.php">&ensp;'.$use.'</a>
                                <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
