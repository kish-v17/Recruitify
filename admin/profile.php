                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-4 col-6 mx-auto" >
                            ...
                            <br/><br/>
                            <button onclick="showForm(1)" class="custom-btn btn ms-lg-auto" style="width:100%;"><i class="fa fa-file-image-o"></i>&ensp;<b>Change Profile</b></button><br/><br/>
                        ...
                        <fieldset style="border:3px solid #808080;border-radius:30px;font-weight:bold;">
                        <legend style="padding:5px 0 0; text-decoration:underline;color:#808080" align="center" ><h3>Personal Information</h3></legend>
                            <div class="contact-info-wrap" style="padding:0 10px 0 10px">
                            ...
                            <div class="col-lg-6 col-12 mb-lg-5 mb-3" align="center">
                                <a onclick="showForm(2)" id="form" class="custom-btn btn ms-lg-auto" width="100%"><i class="fa fa-edit" style="font-size:18px"></i>&ensp;<b>Update Information</b></a>
                            </div>
                            </fieldset>
                        </div>
                    </div>
